...
def gadget_field_add(fname,unit_base,bbox,ds=None):
    ...
    ds.add_field(('starcoordinates'),function=_starcoordinates,units='cmcm',particle_type=True)
    ...
    if ('PartType2','Masses') in ds.derived_field_list:
        ...
        ds.add_field(('diskstarcoordinates'),function=_diskstarcoordinates,units='cmcm',particle_type=True)
    ...
    if ('PartType3','Masses') in ds.derived_field_list:
        ...
        ds.add_field(('bulgestarcoordinates'),function=_bulgestarcoordinates,units='cmcm',particle_type=True)
    
    ds.add_field(('gasdensity'),function=_gasdensity,units='g/cm**3',particle_type=True)
    ds.add_field(('gascoordinates'),function=_gascoordinates,units='cmcm',particle_type=True)
