...
n_MPI_processes = 16 # number of MPI tasks to run. for TORQUE this is
...
SED_MONOCHROMATIC_max_lam = 1.0 # micron
...
N_MASS_BINS = 0 # this is really just a place holder that exists in
