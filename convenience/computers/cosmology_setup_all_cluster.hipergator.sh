...
echo "Gadget_snap_num =  $snap" >> $filem
echo -e "\n" >> $filem
...
echo "python pd_front_end.py $model_dir_remote parameters_master snap${snap}_halo\$SLURM_ARRAY_TASK_ID  > $model_dir_remote/snap${snap}_halo\$SLURM_ARRAY_TASK_ID.LOG">>$qsubfile
