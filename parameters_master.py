...
gas_logu = -2 #gas ionization parameter; only relevant if add_neb_emission == True
gas_logz = 0# gas metallicity in HII regions; only relevant if add_neb_emission == True
