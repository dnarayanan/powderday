...
if par.SKIP_GRID_READIN == False:
    ...
    if os.path.isfile(par.Auto_TF_file) == False:
        ...
        if par.Manual_TF == True: 
            ...
            refined,dustdens,xmin,xmax,ymin,ymax,zmin,zmax = yt_octree_generate(par.Gadget_snap_name,par.Gadget_dir,par.Gadget_snap_num)
...
if par.SUPER_SIMPLE_SED == False:
    ...
    for i in range(nstars):
        ...
        m.add_spherical_source(luminosity = 1.e3*const.lsun,temperature = 6000., radius = 10.*const.rsun,
